...
import { dataset } from './ProductSkeletonData.jsx'
...
const ProductSkeleton = () => {
    ...
    const agent_permission = ['Product request', 'Product List', 'Product Category', 'Sim Inventory', 'Settings', 'Agent Request', 'Users']
