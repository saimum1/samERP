    ...
    const SaveOperator = async (logo) => {
        try {
            ...
            const data = {
                ...
                'code': operatorCode,
                "logo": logo,
                "status": operatorStatus ? 'available' : 'Not available'
            }
...
const UpdateOperator = async (logo) => {
        try {
            ...
            const data = {
                "name": operatorName,
                'code': operatorCode,
                "logo": logourlFromPrev !== ''? logourlFromPrev :  logo,
                "status": operatorStatus ? 'Available' : 'Not available'
            }
    ...
    const UploadOperatorLogo = async () => {
        ...
        if(logourlFromPrev === '' && selectedFile === null){
            setshowpopupmsg('please upload a file')
