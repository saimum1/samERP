...
const handleCopyUID = (uid) => {
  ...
  return (
   ...
   {!nodata?
    <Card className="bg-[#303038]  text-white h-full w-[100%]" style={{border:'none',borderStyle:'none',boxShadow:'none',gap:'2rem',display:'flex',flexDirection:'column'}}>
        ...
        <span onClick={() => {
            ...
            <span  className="flex items-center">
                ...
                <button onClick={()=>callbox()} className="py-2 px-3.5 bg-[#27CF7A] text-white font-bold  rounded-[4px] ">Add New</button>
            </div>
                ...
                {offerList?.map((item,index) => (
                    <TableRow key={index} style={{borderColor:'#595959'}}>
                        ...
                        <TableCell style={{ overflowY: 'auto', width:'15rem',maxWidth: '20rem', maxHeight: '10rem' }}>
                                    <Text>
                                        <div style={{ backgroundColor: '', width: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', whiteSpace: 'pre-wrap', wordBreak: 'break-word'}}>
    ...
    </Card>:<Nodatafound btn_text={'Add New Offer'}  tittle_head={'No Offer List Found'} title_des={'Aliquam porta nisl dolor, molestie pellentesque elit molestie in. Morbi metus neque, elementum ullam'} buttonclicked={onbuttonclicked}/>}
    <style jsx>
